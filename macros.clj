...
; "Macros are like functions created at compile time"
 (println (= "Hello, Macros!" (hello "Macros!"))) 

;   "I can haz infix?"
 (println (= 10 (infix (9 + 1)))) 

;   "Remember, these are nothing but code transformations"
(println (= '(+ 9 1) (macroexpand '(infix (9 + 1)))))  

;   "You can do better than that - hand crafting FTW!"
(println (= '(* 10 2) (macroexpand '(infix-concise (10 * 2)))))  
 
;   "Things don't always work as you would like them to"
(println (= '(+ 10 (2 * 3)) (macroexpand '(infix-concise (10 + (2 * 3))))))  

;   "Really, you don't understand recursion until you understand recursion"
(println (= 36 (recursive-infix (10 + (2 * 3) + (4 * 5)))))  